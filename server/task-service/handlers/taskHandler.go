...
func NewTasksHandler(l *log.Logger, r *repositories.TaskRepository, natsConn *nats.Conn, userClient client.UserClient) *TasksHandler {
	return &TasksHandler{l, r, natsConn, userClient}
}
